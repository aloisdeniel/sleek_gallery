  ...
  Widget build(BuildContext context) {
    ...
    return SleekScaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
          SectionHeader("Base styles", topPadding: false),
          ...
          Bloc(
            color: const Color(0xFF000000).withOpacity(0.02),
            children: <Widget>[
              SleekText("blockquote1", style: SleekTextStyle.blockquote1()),
              SleekText("blockquote2", style: SleekTextStyle.blockquote2()),
              SleekText("blockquote3", style: SleekTextStyle.blockquote3()),
              SleekText("blockquote4", style: SleekTextStyle.blockquote4()),
              SleekText("blockquote5", style: SleekTextStyle.blockquote5()),
              SleekText("blockquote6", style: SleekTextStyle.blockquote6()),
            ],
          ),
          ...
          SleekContent.small(
            child: Bloc(
              ...
              children: <Widget>[
                ...
                SleekText("blockquote", style: SleekTextStyle.blockquote()),
                Bloc(
                  color: sleek.palette.primary,
                  children: <Widget>[
